...
public class SocioDTO {
    ...
    public SocioDTO(int idPaciente, String suscrip, String nombre, String apellido, String dni, Date fechaNacimiento, int telefono, String mail, String espPersona, String espPaciente, int idSocio, String numAfiliado, int suscripcionId) {
